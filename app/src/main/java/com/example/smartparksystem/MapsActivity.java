...
import directionhelpers.DataParser;
...
public class MapsActivity extends
        FragmentActivity implements OnMapReadyCallback, GoogleApiClient.ConnectionCallbacks,
...
//                    mMap.addMarker(new MarkerOptions().position(latlong).title(loc + " " + "Parking"));
                        mMap.animateCamera(CameraUpdateFactory.newLatLngZoom(latlong, 10));
                    }
...
//        String APIKEY = getResources().getString(R.string.google_maps_key);
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        //        final BitmapDescriptor icon= BitmapDescriptorFactory.fromResource(R.drawable.ic_baseline_local_parking_24);
